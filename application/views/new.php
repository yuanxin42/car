					...
					<div class="menu">
						<div class="top-nav">
							<ul>
								...
								<li class="active"><a href=<?php echo site_url('Car_new/index')?>>超值特价车</a></li>
								...
								<div class="content-wrapper">
									<div class="content-top">
										<div class="about_wrapper">
											<h1 id='ninecar'>9成新二手车</h1>
										</div>
										<div class="text">
											<?php 
												for ($x=0; $x<count($nine_car); $x++) {
											?>
											<div class="grid_1_of_3 images_1_of_3 all_car">
												<div class="grid_1">
													<a href="http://localhost/car/index.php/Car_index/xiangqing?type=ne&id=<?php echo $nine_car[$x]->car_id?>"><img src=<?php echo $nine_car[$x]->img?> title="点击查看车辆详情" alt=""></a>
													<div class="grid_desc">
														<p class="title"><?php echo $nine_car[$x]->title?></p>
														<p class="title1"><?php echo $nine_car[$x]->information?></p>
														<div class="price" style="height: 19px;">
															<span class="reducedfrom">￥<?php echo $nine_car[$x]->price?></span>
															<span class="actual">￥<?php echo $nine_car[$x]->oldprice?></span>
														</div>
														<div class="cart-button">
															<div class="cart">
																<button class="button"><span><a href="http://localhost/car/index.php/Car_index/shoping?type=ne&id=<?php echo $nine_car[$x]->car_id?>&">购买</a></span></button>
															</div>
															<button class="button"><a href="http://localhost/car/index.php/Car_index/xiangqing?type=ne&id=<?php echo $nine_car[$x]->car_id?>">详情</a></button>
															<div class="clear"></div>
														</div>
													</div>
												</div>
									...
									<div class="content-top">
										<div class="box_wrapper">
											<h1 id='eightcar'>8成新二手车</h1>
										</div>
										<div class="text">
											<?php 
												for ($x=0; $x<count($eight_car); $x++) {
											?>
											<div class="grid_1_of_3 images_1_of_3 all_car">
												<div class="grid_1">
													<a href="http://localhost/car/index.php/Car_index/xiangqing?id=<?php echo $eight_car[$x]->car_id?>"><img src=<?php echo $eight_car[$x]->img?> title="点击查看车辆详情" alt=""></a>
													<div class="grid_desc">
														<p class="title"><?php echo $eight_car[$x]->title?></p>
														<p class="title1"><?php echo $eight_car[$x]->information?></p>
														<div class="price" style="height: 19px;">
															<span class="reducedfrom">￥<?php echo $eight_car[$x]->price?></span>
															<span class="actual">￥<?php echo $eight_car[$x]->oldprice?></span>
														</div>
														<div class="cart-button">
															<div class="cart">
																<button class="button"><span><a href="http://localhost/car/index.php/Car_index/shoping?type=ne&id=<?php echo $eight_car[$x]->car_id?>&">购买</a></span></button>
															</div>
															<button class="button"><a href="http://localhost/car/index.php/Car_index/xiangqing?id=<?php echo $eight_car[$x]->car_id?>">详情</a></button>
															<div class="clear"></div>
														</div>
													</div>
												</div>
